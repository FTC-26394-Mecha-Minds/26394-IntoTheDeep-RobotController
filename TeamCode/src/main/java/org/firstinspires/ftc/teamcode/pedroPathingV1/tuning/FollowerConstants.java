...
import org.firstinspires.ftc.teamcode.pedroPathingV1.util.CustomFilteredPIDFCoefficients;
import org.firstinspires.ftc.teamcode.pedroPathingV1.util.CustomPIDFCoefficients;
import org.firstinspires.ftc.teamcode.pedroPathingV1.util.KalmanFilterParameters;
...
public class FollowerConstants {
    ...
    private static double xMovement = 54.87112618801825;
    private static double yMovement = 36.28479878809338;
    ...
    public static double mass = 11.5666054;
    ...
    public static double forwardZeroPowerAcceleration =  -46.40179106626257;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -70.39147949613829;
