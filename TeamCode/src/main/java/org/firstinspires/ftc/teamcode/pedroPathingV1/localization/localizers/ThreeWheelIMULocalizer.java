package org.firstinspires.ftc.teamcode.pedroPathingV1.localization.localizers;
...
import org.firstinspires.ftc.teamcode.pedroPathingV1.localization.Encoder;
import org.firstinspires.ftc.teamcode.pedroPathingV1.localization.Localizer;
import org.firstinspires.ftc.teamcode.pedroPathingV1.localization.Matrix;
...
import org.firstinspires.ftc.teamcode.pedroPathingV1.util.NanoTimer;
...
ThreeWheelIMULocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES =0.001976892221253142;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = -0.001995258526697436;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = 0.0020150962664597515;//8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(-3.875, 4.375, 0);
        rightEncoderPose = new Pose(-3.875, -4.375, 0);
        strafeEncoderPose = new Pose(-1.875, -0.125, Math.toRadians(90));
